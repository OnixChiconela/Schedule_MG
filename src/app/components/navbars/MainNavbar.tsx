          ...
          <div className="flex flex-row items-center justify-between py-4 mx-auto">
            ...
            {showNotificationBell && (
              ...
              >
                ...
                {notificationCount > 0 && (
                  <span
                    className={`absolute -top-1 -right-1 w-5 h-5 flex items-center justify-center text-xs font-semibold rounded-full ${theme === "light" ? "bg-red-500 text-white" : "bg-red-600 text-neutral-200"
                      }`}
                  >
